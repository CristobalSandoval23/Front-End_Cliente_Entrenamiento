...
class _LineChartSample2State extends State<LineChartSample2> {
        ...
        DatosCorporalesBloc datosCorporalesBloc;
  DatosCorporalesModel datosCorporales = new DatosCorporalesModel();
    List<FlSpot> _items;
  List<double> _xAxis;
    double x;
    double y;
   ...
   _loadData() async {
    await Future.delayed(Duration(seconds: 0));
            ...
            datosCorporalesBloc = ProviderLocal.datosCorporalesBlog(context);
  
     final DatosCorporalesModel prodData = ModalRoute.of(context).settings.arguments;
    if ( prodData != null ) {
      datosCorporales = prodData;
    }
    // final List list;
    // setState(() {
      // _items = 
      //     datosCorporales.fromMap((item) => FlSpot(
      //         double.parse(item.datoAgregadoDeMedidasCorporales.toString()),
      //         double.parse(item.datoAgregadoDeMedidasCorporales.toString())))
      //     .toList();
    // });
  }
